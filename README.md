...
![최종Vue](README.assets/최종Vue.png)
...
![최종_modeling](README.assets/최종_modeling.png)
...
![최종URL](README.assets/최종URL.png)
...
- 여기서 첫 번째 문제는 인기도와 평점의 점수 분포인데, 인기도는 0 ~ 4500의 분포를 가지고 있었고, 평점은 0 ~ 10의 분포를 가지고 있었다(또한, 정규분포도 아니다). 그래서 다음과 같은 방법을 생각했다.
